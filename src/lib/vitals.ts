...
interface SendToAnalyticsOptions {
...
const sendToAnalytics = (metric: Metric, options: SendToAnalyticsOptions) => {
...
export const webVitals = (options: SendToAnalyticsOptions) => {
	try {
